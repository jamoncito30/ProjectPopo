...
public final class DungBeetleEntity extends AnimalEntity {
    ...
    public static DefaultAttributeContainer.Builder createAttributes() {
        return AnimalEntity.createMobAttributes().add(EntityAttributes.MAX_HEALTH, 8)
                .add(EntityAttributes.MOVEMENT_SPEED, 0.22).add(EntityAttributes.FOLLOW_RANGE, 16);
    }
    ...
    @Override public PassiveEntity createChild(ServerWorld world, PassiveEntity other) { return ModEntities.DUNG_BEETLE.create(world, net.minecraft.entity.SpawnReason.NATURAL); }
    ...
    @Override protected void dropInventory(net.minecraft.server.world.ServerWorld world) {
        super.dropInventory(world);
        if (getCarrying() > 0) { dropStack((net.minecraft.server.world.ServerWorld)this.getWorld(), new ItemStack(ModItems.POPO, getCarrying())); setCarrying(0); }
    }
