...
public final class BeetleNestBlock extends BlockWithEntity {
    ...
    @Override protected void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState next, boolean moved) {
        ...
        net.minecraft.util.ItemScatterer.spawn(world, pos.getX(), pos.getY(), pos.getZ(), new net.minecraft.item.ItemStack(org.examplee.proyecto_intento.item.ModItems.POPO, state.get(STAGE))); super.onStateReplaced(state, world, pos, next, moved);
    }
}
