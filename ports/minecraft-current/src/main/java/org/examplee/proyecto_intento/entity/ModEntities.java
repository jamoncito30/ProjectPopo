...
public final class ModEntities {
    public static final EntityType<ToiletSeatEntity> TOILET_SEAT = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of("proyecto_intento","toilet_seat"),EntityType.Builder.<ToiletSeatEntity>create(ToiletSeatEntity::new,SpawnGroup.MISC).dimensions(.1F,.1F).disableSaving().disableSummon().maxTrackingRange(4).build(net.minecraft.registry.RegistryKey.of(net.minecraft.registry.RegistryKeys.ENTITY_TYPE, Identifier.of("proyecto_intento", "toilet_seat"))));
    public static final EntityType<PopoProjectileEntity> POPO_PROJECTILE = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of("proyecto_intento", "popo_projectile"), EntityType.Builder.<PopoProjectileEntity>create(PopoProjectileEntity::new, SpawnGroup.MISC)
                    .dimensions(0.25F, 0.25F).maxTrackingRange(4).trackingTickInterval(10).build(net.minecraft.registry.RegistryKey.of(net.minecraft.registry.RegistryKeys.ENTITY_TYPE, Identifier.of("proyecto_intento", "popo_projectile"))));
    public static final EntityType<DungBeetleEntity> DUNG_BEETLE = Registry.register(Registries.ENTITY_TYPE,
            Identifier.of("proyecto_intento", "dung_beetle"), EntityType.Builder.create(DungBeetleEntity::new, SpawnGroup.CREATURE)
                    .dimensions(0.65F, 0.4F).maxTrackingRange(8).build(net.minecraft.registry.RegistryKey.of(net.minecraft.registry.RegistryKeys.ENTITY_TYPE, Identifier.of("proyecto_intento", "dung_beetle"))));
