...
public final class ModPotions {
    public static final RegistryEntry<Potion> PESTILENCE = Registry.registerReference(Registries.POTION,
            Identifier.of("proyecto_intento","pestilence"),new Potion("pestilence",new StatusEffectInstance(net.minecraft.entity.effect.StatusEffects.NAUSEA,400)));
    ...
    public static void initialize() {
        FabricBrewingRecipeRegistryBuilder.BUILD.register(builder -> builder.registerPotionRecipe(Potions.AWKWARD,ModItems.VISCOUS_BIOMASS,PESTILENCE));
